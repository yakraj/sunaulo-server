...
const otpsender = () => (req, res) => {
  ...
  axios({
    method: "get",
    url: `https://www.fast2sms.com/dev/bulkV2?authorization=KLF32bSuRJ9eBpwsZdQ4fWaGV6HhDtog7CTY5UjlEiX0mIyvnc1k9HQbtMX6zpi4cIdgaqBNxG7j5sYm&variables_values=${MobileOtp}&route=otp&numbers=${mobile}`,
    // responseType: 'stream'
