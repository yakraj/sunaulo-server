var urlSignature = (function (exports, Base64, HmacSHA1) {
	...
	var uncurryThis$m = bind$5 && bind$5.bind(call$f, call$f);
	...
	var fails$i = fails$j; // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
	...
	var fails$h = fails$j; // Detect IE8's incomplete defineProperty implementation
	...
	var fails$f = fails$j; // V8 ~ Chrome 36-
